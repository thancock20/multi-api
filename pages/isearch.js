...
class Timestamp extends React.Component {
    ...
    return (
      <Layout title="Image Search Abstraction Layer">
        ...
        <ul>
          ...
          <li>
            I can paginate through the responses by adding an offset parameter
            to the URL.
          </li>
          <li>
        ...
        <Code>
          {this.state.hostname}/api/isearch?term=lolcats%20funny&offset=10
        </Code>
  ...
  },
  {
    ...
    "pageUrl": "http://www.dailymail.co.uk/news/article-562690/Feline-funny-The-cult-website-dedicated-comedy-cats.html"
        ...
        <Code>{this.state.hostname}/api/isearch/recent</Code>
